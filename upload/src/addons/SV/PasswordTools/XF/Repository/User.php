...
class User extends XFCP_User
{
    ...
    public function setupBaseUser(?\XF\Entity\User $user = null)
    {
        ...
        // XF bug; the created entities don't link back to the User entity
        // https://xenforo.com/community/threads/userrepo-setupbaseuser-doesnt-setup-dependant-entities-as-expected.223540/
